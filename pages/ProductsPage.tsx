...
export default function ProductsPage() {
  ...
  return (
    <div className="p-4 pb-24">
      ...
      <div className="sticky top-0 sm:top-[4rem] z-40 py-4 space-y-4 -mx-4 px-4 shadow-sm mb-6 border-b border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-900 transition-colors duration-200">
